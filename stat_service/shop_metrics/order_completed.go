...
func (s *shopOrderCompletedMetric) FetchMetric(ctx context.Context, ids []uint64, filter *selling_iface.ShopStatMetricFilter) (*selling_iface.ShopMetric, error) {
	...
	return &selling_iface.ShopMetric{
		Data: &selling_iface.ShopMetric_ShopOrderCompletedMetric{
			ShopOrderCompletedMetric: &result,
		},
	}, err
}

// ProcessSort implements [ShopMetricBase].
func (s *shopOrderCompletedMetric) ProcessSort(ctx context.Context, filter *selling_iface.ShopStatMetricFilter, sort *selling_iface.ShopMetricSort) ([]uint64, error) {
	var err error
...
func NewShopOrderCompletedMetric(db *gorm.DB) ShopMetricBase {
	return &shopOrderCompletedMetric{db}
}
