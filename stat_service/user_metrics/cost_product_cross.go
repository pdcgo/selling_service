...
type costUserProductCross struct {
	db *gorm.DB
}

// FetchMetric implements [UserMetricBase].
func (u *costUserProductCross) Query(ctx context.Context, ufilter *selling_iface.UserStatMetricFilter) (*gorm.DB, error) {
...
// FetchMetric implements [UserMetricBase].
func (u *costUserProductCross) FetchMetric(ctx context.Context, userIds []uint64, ufilter *selling_iface.UserStatMetricFilter) (*selling_iface.UserMetric, error) {
	var err error

	result := &user_metric.UserCostProductCrossMetric{
		Data: map[uint64]*user_metric.UserCostProductCrossItem{},
	}
	...
	resultList := []*user_metric.UserCostProductCrossItem{}
	err = query.
	...
	return &selling_iface.UserMetric{
		Data: &selling_iface.UserMetric_UserCostProductCrossMetric{
			UserCostProductCrossMetric: result,
		},
	}, err
}

// ProcessSort implements [UserMetricBase].
func (u *costUserProductCross) ProcessSort(ctx context.Context, ufilter *selling_iface.UserStatMetricFilter, usort *selling_iface.UserMetricSort) ([]uint64, error) {
	var err error
	var ids []uint64
	...
	switch usort.GetUserCostProductCrossMetricSort() {
	case user_metric.UserCostProductCrossMetricSort_USER_COST_PRODUCT_CROSS_METRIC_SORT_PRODUCT_CROSS_AMOUNT:
...
func NewUserCostProductCrossMetric(db *gorm.DB) UserMetricBase {
	return &costUserProductCross{db: db}
}
